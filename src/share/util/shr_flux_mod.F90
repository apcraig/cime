...
!-------------------------------------------------------------------------------
   ...
   ENDDO
    ...
    do n = 1,nMax
       if (mask(n) /= 0) then
          write(6,*)'DEBUG atmocn flux n,mask  = ',n,mask(n)
          write(6,*)'DEBUG atmocn flux n,zbot  = ',n,zbot(n)
          write(6,*)'DEBUG atmocn flux n,ubot  = ',n,ubot(n)
          write(6,*)'DEBUG atmocn flux n,vbot  = ',n,vbot(n)
          write(6,*)'DEBUG atmocn flux n,thbot = ',n,thbot(n)
          write(6,*)'DEBUG atmocn flux n,qbot  = ',n,qbot(n)
          write(6,*)'DEBUG atmocn flux n,tbot  = ',n,tbot(n)
          write(6,*)'DEBUG atmocn flux n,us    = ',n,us(n)
          write(6,*)'DEBUG atmocn flux n,vs    = ',n,vs(n)
          write(6,*)'DEBUG atmocn flux n,ts    = ',n,ts(n)

          write(6,*)'DEBUG atmocn flux n,lat   = ',n,lat(n)
          write(6,*)'DEBUG atmocn flux n,sen   = ',n,sen(n)
          write(6,*)'DEBUG atmocn flux n,taux  = ',n,taux(n)
          write(6,*)'DEBUG atmocn flux n,taux  = ',n,tauy(n)
          write(6,*)'DEBUG atmocn flux n,lwup  = ',n,lwup(n)
          write(6,*)'DEBUG atmocn flux n,evap  = ',n,evap(n)
       end if
    end do
