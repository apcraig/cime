module seq_flds_mod
  ...
  !  ---------
  !  1) states:
  !     a) atm attributes fields that HAVE a state-prefix of Sx_ in flds_x2a
  ...
  !
  !     b) atm attribute fields that DO NOT HAVE a state-prefix of Sx_ in flds_x2a
  ...
  ! by the user in the cpl namelist flds_user using the namelist variable
  ...
  !====================================================================
   ...
   public :: seq_flds_set
   public :: flds_get_num_entries
   public :: flds_get_entry
   ...
   private :: dom_add
   private :: fld_add
   private :: set_glc_elevclass_field
   private :: catFields
   private :: metadata_set
   private :: flds_metadata_entry
   private :: flds_esmf_metadata_get
   ...
   integer , parameter :: seq_flds_scalar_index_glc_coupled        = 16 ! does glc send fluxes to other components
   ...
   !----------------------------------------------------------------------------
   ! combined state and flux fields
   !----------------------------------------------------------------------------
...
!----------------------------------------------------------------------------
   ...
   subroutine seq_flds_set(nmlfile, ID, cime_model)
     ...
     character(len=*),parameter :: subname = '(flds_set) '
     !-------------------------------------------------------------------------------
     ...
     call metadata_set(attname, longname, stdname, units=units)
     ...
     stdname  = 'latitude'
     units    = 'degrees north'
     call dom_add(dom_coord,'lat', longname, stdname, units=units)

     longname = 'longitude'
     stdname  = 'longitude'
     units    = 'degrees east'
     call dom_add(dom_coord,'lon', longname, stdname, units=units)

     longname = 'height'
     stdname  = 'height, depth, or levels'
     units    = 'unitless'
     call dom_add(dom_coord,'hgt', longname, stdname, units=units)

     longname = 'cell_area_model'
     stdname  = 'cell area from model'
     units    = 'radian^2'
     call dom_add(dom_other,'area', longname, stdname, units=units)

     longname = 'cell_area_mapping'
     stdname  = 'cell area from mapping file'
     units    = 'radian^2'
     call dom_add(dom_other,'aream', longname, stdname, units=units)

     longname = 'mask'
     stdname  = 'mask'
     units    = '1'
     call dom_add(dom_other,'mask', longname, stdname, units=units)

     longname = 'area_fraction'
     stdname  = 'area fraction'
     units    = '1'
     call dom_add(dom_other,'frac', longname, stdname, units=units)
     ...
     if (trim(cime_model) == 'acme') then
        call fld_add(flds_x2o, flds_x2o_map, "Sa_pbot")
     end if
     ...
     if (trim(cime_model) == 'acme') then
        ...
        units    = 'Pa'
        call fld_add(flds_i2x, flds_i2x_map, "Si_bpress", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Si_bpress")
     end if
     ...
     if (trim(cime_model) == 'acme') then
        ...
        stdname  = 'surface_snow_and_ice_melt_heat_flux'
        units    = 'W m-2'
        call fld_add(flds_o2x, flds_o2x_map, "Fioo_meltp", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "Fioo_meltp")
     end if
     ...
     if (trim(cime_model) == 'acme') then
        ...
        units    = 'kg m-2 s-1'
        call fld_add(flds_o2x, flds_o2x_map, "Fioo_frazil", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "Fioo_frazil")
     end if
     ...
     if (trim(cime_model) == 'acme' .and. flds_bgc) then
        ...
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_algae1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_algae1")

        ! Ocean algae concentration 2 - flagellates?
        longname = 'Ocean algae concentration 2 - flagellates'
        stdname  = 'ocean_algae_conc_2'
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_algae2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_algae2")

        ! Ocean algae concentration 3 - phaeocyctis?
        longname = 'Ocean algae concentration 3 - phaeocyctis'
        stdname  = 'ocean_algae_conc_3'
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_algae3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_algae3")
        ...
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_doc1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_doc1")
        ...
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_doc2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_doc2")
        ...
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_doc3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_doc3")
        ...
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_dic1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_dic1")
        ...
        units    = 'mmol N m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_don1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_don1")

        ! Ocean nitrate concentration
        longname = 'Ocean nitrate concentration'
        stdname  = 'ocean_nitrate_conc'
        units    = 'mmol N m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_no3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_no3")

        ! Ocean silicate concentration
        longname = 'Ocean silicate concentration'
        stdname  = 'ocean_silicate_conc'
        units    = 'mmol Si m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_sio3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_sio3")

        ! Ocean ammonium concentration
        longname = 'Ocean ammonium concentration'
        stdname  = 'ocean_ammonium_conc'
        units    = 'mmol N m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_nh4", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_nh4")

        ! Ocean dimethyl sulfide (DMS) concentration
        longname = 'Ocean dimethyl sulfide concentration'
        stdname  = 'ocean_dimethyl_sulfide_conc'
        units    = 'mmol S m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_dms", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_dms")
        ...
        units    = 'mmol S m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_dmsp", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_dmsp")

        ! Ocean DOCr concentration
        longname = 'Ocean DOCr concentration'
        stdname  = 'ocean_DOCr_conc'
        units    = 'mmol C m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_docr", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_docr")
        ...
        units    = 'umol Fe m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_fep1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_fep1")
        ...
        units    = 'umol Fe m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_fep2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_fep2")

        ! Ocean dissolved iron concentration 1
        longname = 'Ocean dissolved iron concentration 1'
        stdname  = 'ocean_dissolved_iron_conc_1'
        units    = 'umol Fe m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_fed1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_fed1")

        ! Ocean dissolved iron concentration 2
        longname = 'Ocean dissolved iron concentration 2'
        stdname  = 'ocean_dissolved_iron_conc_2'
        units    = 'umol Fe m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_fed2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_fed2")

        ! Ocean z-aerosol concentration 1
        longname = 'Ocean z-aerosol concentration 1'
        stdname  = 'ocean_z_aerosol_conc_1'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer1")

        ! Ocean z-aerosol concentration 2
        longname = 'Ocean z-aerosol concentration 2'
        stdname  = 'ocean_z_aerosol_conc_2'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer2")

        ! Ocean z-aerosol concentration 3
        longname = 'Ocean z-aerosol concentration 3'
        stdname  = 'ocean_z_aerosol_conc_3'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer3")

        ! Ocean z-aerosol concentration 4
        longname = 'Ocean z-aerosol concentration 4'
        stdname  = 'ocean_z_aerosol_conc_4'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer4", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer4")

        ! Ocean z-aerosol concentration 5
        longname = 'Ocean z-aerosol concentration 5'
        stdname  = 'ocean_z_aerosol_conc_5'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer5", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer5")

        ! Ocean z-aerosol concentration 6
        longname = 'Ocean z-aerosol concentration 6'
        stdname  = 'ocean_z_aerosol_conc_6'
        units    = 'kg m-3'
        call fld_add(flds_o2x, flds_o2x_map, "So_zaer6", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2i, flds_x2i_map, "So_zaer6")

        ! Sea ice algae flux 1 - diatoms?
        longname = 'Sea ice algae flux 1 - diatoms'
        stdname  = 'seaice_algae_flux_1'
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_algae1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_algae1", longname=longname, stdname=stdname, units=units)

        ! Sea ice algae flux 2 - flagellates?
        longname = 'Sea ice algae flux 2 - flagellates'
        stdname  = 'seaice_algae_flux_2'
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_algae2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_algae2", longname=longname, stdname=stdname, units=units)

        ! Sea ice algae flux 3 - phaeocyctis?
        longname = 'Sea ice algae flux 3 - phaeocyctis'
        stdname  = '_algae_flux_3'
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_algae3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_algae3", longname=longname, stdname=stdname, units=units)
        ...
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_doc1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_doc1", longname=longname, stdname=stdname, units=units)
        ...
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_doc2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_doc2", longname=longname, stdname=stdname, units=units)
        ...
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_doc3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_doc3", longname=longname, stdname=stdname, units=units)
        ...
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_dic1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_dic1", longname=longname, stdname=stdname, units=units)
        ...
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_don1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_don1", longname=longname, stdname=stdname, units=units)

        ! Sea ice nitrate flux
        longname = 'Sea ice nitrate flux'
        stdname  = 'seaice_nitrate_flux'
        units    = 'mmol N m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_no3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_no3", longname=longname, stdname=stdname, units=units)

        ! Sea ice silicate flux
        longname = 'Sea ice silicate flux'
        stdname  = 'seaice_silicate_flux'
        units    = 'mmol Si m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_sio3", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_sio3", longname=longname, stdname=stdname, units=units)

        ! Sea ice ammonium flux
        longname = 'Sea ice ammonium flux'
        stdname  = 'seaice_ammonium_flux'
        units    = 'mmol N m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_nh4", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_nh4", longname=longname, stdname=stdname, units=units)
        ...
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_dms", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_dms", longname=longname, stdname=stdname, units=units)

        ! Sea ice DMSPp flux
        longname = 'Sea ice DSMPp flux'
        stdname  = 'seaice_DSMPp_flux'
        units    = 'mmol S m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_dmspp", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_dmspp", longname=longname, stdname=stdname, units=units)

        ! Sea ice DMSPd flux
        longname = 'Sea ice DSMPd flux'
        stdname  = 'seaice_DSMPd_flux'
        units    = 'mmol S m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_dmspd", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_dmspd", longname=longname, stdname=stdname, units=units)

        ! Sea ice DOCr flux
        longname = 'Sea ice DOCr flux'
        stdname  = 'seaice_DOCr_flux'
        units    = 'mmol C m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_docr", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_docr", longname=longname, stdname=stdname, units=units)
        ...
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_fep1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_fep1", longname=longname, stdname=stdname, units=units)

        ! Sea ice particulate iron flux 2
        longname = 'Sea ice particulate iron flux 2'
        stdname  = 'seaice_particulate_iron_flux_2'
        units    = 'umol Fe m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_fep2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_fep2", longname=longname, stdname=stdname, units=units)

        ! Sea ice dissolved iron flux 1
        longname = 'Sea ice dissolved iron flux 1'
        stdname  = 'seaice_dissolved_iron_flux_1'
        units    = 'umol Fe m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_fed1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_fed1", longname=longname, stdname=stdname, units=units)

        ! Sea ice dissolved iron flux 2
        longname = 'Sea ice dissolved iron flux 2'
        stdname  = 'seaice_dissolved_iron_flux_2'
        units    = 'umol Fe m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_fed2", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_fed2", longname=longname, stdname=stdname, units=units)

        ! Sea ice iron dust
        longname = 'Sea ice iron dust 1'
        stdname  = 'seaice_iron_dust_1'
        units    = 'kg m-2 s-1'
        call fld_add(flds_i2x, flds_i2x_map, "Fioi_dust1", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2o, flds_x2o_map, "Foxx_dust1", longname=longname, stdname=stdname, units=units)
     ...
     units    = 'kg m-2 s-1'
     call set_glc_elevclass_field(name, attname, longname, stdname, units, flds_l2x, flds_l2x_map)
     call set_glc_elevclass_field(name, attname, longname, stdname, units, flds_l2x_to_glc, flds_l2x_to_glc_map, &
     ...
     call fld_add(flds_g2x, flds_g2x_map, trim(name), longname=longname, stdname=stdname, units=units)
     call fld_add(flds_g2x_to_lnd, flds_g2x_to_lnd_map,trim(name), longname=longname, stdname=stdname, units=units)
     call set_glc_elevclass_field(name, attname, longname, stdname, units, flds_x2l, flds_x2l_map)
     call set_glc_elevclass_field(name, attname, longname, stdname, units, flds_x2l_from_glc, flds_x2l_from_glc_map, &
          additional_list=.true.)
     ...
     if (flds_co2a) then
        ...
        units    = 'moles m-2 s-1'
        call fld_add(flds_o2x, flds_o2x_map, "Faoo_fdms_ocn", longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2a, flds_x2a_map, "Faxx_fdms_ocn", longname=longname, stdname=stdname, units=units)
     ...
     if ( lnd_drydep ) then
        ...
        stdname  = 'drydep_vel'
        units    = 'cm/sec'
        call fld_add(flds_l2x, flds_l2x_map, seq_drydep_fields, longname=longname, stdname=stdname, units=units)
        call fld_add(flds_x2a, flds_x2a_map, seq_drydep_fields, longname=longname, stdname=stdname, units=units)
     endif
   ...
   subroutine dom_add(fldlist, fldname, longname, stdname, units)
     ...
     if (present(longname) .and. present(stdname) .and. present(units)) then
        call metadata_set(trim(fldname), longname, stdname, units)
     endif

   end subroutine dom_add
   ...
   subroutine fld_add(fldlist, maplist, fldname, longname, stdname , units)
     ...
     ! TODO: add this - currently turned off - but need to turn it back on
     ...
     if (present(longname) .and. present(stdname) .and. present(units)) then
        call metadata_set(trim(fldname), longname=longname, stdname=stdname, units=units)
     endif
   ...
   subroutine catFields(outfield, str1, str2)
     ...
     ! Returns 'nfld' concatentated field lists in the output character string 'outfield'.
     ...
     ! local variables
     character(len=*),parameter :: subname = '(catFields) '
     !-------------------------------------------------------------------------------
   ...
   subroutine metadata_set(attname , longname, stdname, units)
     ...
     ! local variables
     integer :: i, j
     character(len=*),parameter :: subname = '(metadata_set) '
     !-------------------------------------------------------------------------------
     ...
     do while(i>j .and. i<=len_trim(attname))
        if (flds_metadata_entry(attname(j:i-1)) <= 0) then
     ...
     enddo
     if (flds_metadata_entry(attname(j:i)) <= 0) then
        n_entries = n_entries + 1
        i = len_trim(attname)
   ...
   subroutine set_glc_elevclass_field(name, attname, longname, stdname, units, fieldlist, maplist, additional_list)
   ...
   subroutine flds_get_num_entries(num_entries)

     ! !INPUT/OUTPUT PARAMETERS:
     integer, intent(out)  :: num_entries

     character(len=*),parameter :: subname = '(flds_get_num_entries) '
     !-------------------------------------------------------------------------------

     num_entries = n_entries

   end subroutine flds_get_num_entries

   !===============================================================================

   subroutine flds_get_entry(nentry, shortname, longname, stdname, units)
     ...
     character(len=*),parameter :: subname = '(flds_get_entry) '
     !-------------------------------------------------------------------------------
   ...
   end subroutine flds_get_entry

   !===============================================================================

   integer function flds_metadata_entry(shortname)
     ...
     !--- local ---
     integer :: nentry
     character(len=*),parameter :: subname = '(flds_metadata_entry) '
     !-------------------------------------------------------------------------------

     call flds_esmf_metadata_get(shortname, nentry=nentry)
     flds_metadata_entry = nentry

   end function flds_metadata_entry

   !===============================================================================

   subroutine flds_esmf_metadata_get(shortname, longname, stdname, units, nentry)
     ...
     logical :: found
     character(len=*),parameter :: subname = '(flds_esmf_metadata_get) '
     !-------------------------------------------------------------------------------
   ...
   end subroutine flds_esmf_metadata_get
